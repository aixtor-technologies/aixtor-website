...
const FounderCard = ({ name, role, bio, image, linkedin }: Founder) => (
  <div className="founder-card group relative overflow-hidden cursor-pointer w-full sm:w-56 md:w-64 lg:w-72 transition-shadow duration-700 group-hover:shadow-card-xl">
    ...
    >
      <Typography
        variant="p"
        size="h6"
        className="text-dark-400 font-bold text-lg leading-snug"
      >
        {name}
      </Typography>
      <Typography
        variant="p"
        size="p"
        className="text-dark-400 text-sm mt-1 mb-4"
      >
        {role}
      </Typography>
      <Typography
        variant="p"
        size="p"
        className="text-dark-400 text-sm leading-relaxed"
      >
        {bio}
      </Typography>
